#x <- read.csv("C:/Users/HP USER/Desktop/fy05.csv", sep="!@!")

#'dat <- readLines("C:/Users/HP USER/Desktop/fy05.csv", n=1000)
#dat <- gsub("!@!,!@!", "|", dat)
#dat <- gsub("!@!", "", dat)
...
dial.plot <- function(label = "DOD!", value = 78, dial.radius = 1
...
par(mar=c(0.2,0.2,0.2,0.2), bg="black", mfrow=c(1,4))

dial.plot ()
dial.plot (label = "Army", value = 25, dial.radius = 1
...
dial.plot (label = "Air Force", value = 63, dial.radius = .7
...
dial.plot (label = "Navy", value = 83, dial.radius = .7
           , value.cex = 2.3, value.color = "white"
           , label.cex = 1.7, label.color = "white"
           , gage.bg.color = "black"
